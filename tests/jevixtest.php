...
require(dirname(dirname(__FILE__)) . '/jevix.class.php');
...
<br/>
BEGIN XSS test <img src="http://hhh=&quot;onclick=&quot;alert(document.cookie)" width="300px" height="300px"/>END XSS test<br/>
<br/>
переходим к &lt;тегам&gt;<br/>
список требуемых<br/>
список <b>разрешённых</b> и запрещённых тегов, их параметров и другие настройки можно задать в <a href="#" rel="123">конфигурации</a><br/>
защита от XSS <br/>
